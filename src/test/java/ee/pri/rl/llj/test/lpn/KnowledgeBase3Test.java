...
public class KnowledgeBase3Test extends TestCase {
	private LLJContext context;

	public KnowledgeBase3Test() throws LLJException {
		context = new LLJContext("ee:pri:rl:llj:test:lpn:kb3");
	}
	...
	public void testAirGuitarButch() throws LLJException {
		RuntimeQuery query = context.createQuery("playsAirGuitar(butch)");
