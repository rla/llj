...
public class TrainsTest extends TestCase {
	...
	public TrainsTest() throws LLJException {
		context = new LLJContext("ee:pri:rl:llj:test:lpn:trains");
	}

	public void testTravelBetweenNancySaarbruecken() throws LLJException {
		RuntimeQuery query = context.createQuery("travelBetween(nancy,saarbruecken)");
